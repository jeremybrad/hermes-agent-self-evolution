...
def skill_fitness_metric(
    ...
    Compatible with both dspy.GEPA (which calls metric(gold, pred, trace,
    pred_name, pred_trace) — 5 positional args, dspy ≥3.2) and the simpler
    3-arg form used by MIPROv2 / BootstrapFewShot. Extra args are accepted
    and ignored — the heuristic doesn't yet use trace/pred_name data, but
    keeping a unified signature lets GEPA pass without falling back.
